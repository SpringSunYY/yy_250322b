  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="payHistoryInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="支付记录编号" align="center" v-if="columns[0].visible" prop="historyId" />
        <el-table-column label="预定编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="reserveId" />
        <el-table-column label="房间编号" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="roomId" />
        <el-table-column label="用户" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="userId" />
        <el-table-column label="实际支付金额" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="payPrice" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="预定编号" prop="reserveId">
          <el-input v-model="form.reserveId" placeholder="请输入预定编号" />
        </el-form-item>
        <el-form-item label="房间编号" prop="roomId">
...
<script>
import { listPayHistoryInfo, getPayHistoryInfo, delPayHistoryInfo, addPayHistoryInfo, updatePayHistoryInfo } from "@/api/manage/payHistoryInfo";
...
export default {
  ...
  data() {
    return {
      //表格展示列
      columns: [
        { key: 0, label: '支付记录编号', visible: true },

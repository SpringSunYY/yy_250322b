  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roomInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="房间编号" align="center" v-if="columns[0].visible" prop="roomId" />
        <el-table-column label="房间名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="roomName" />
        <el-table-column label="房间价格" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="roomPrice" />
        <el-table-column label="房间描述" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="roomDesc" />
        ...
        <el-table-column label="订房次数" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="reserveNum" />

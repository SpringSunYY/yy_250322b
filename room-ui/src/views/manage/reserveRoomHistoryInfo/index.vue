  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reserveRoomHistoryInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="记录编号" align="center" v-if="columns[0].visible" prop="historyId" />
        <el-table-column label="房间编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="roomId" />
        <el-table-column label="用户" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="userId" />
        <el-table-column label="订房天数" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="dayNum" />
        <el-table-column label="订单总价" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="totalPrice" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订房天数" prop="dayNum">
          <el-input v-model="form.dayNum" placeholder="请输入订房天数" />
        </el-form-item>
...
<script>
import { listReserveRoomHistoryInfo, getReserveRoomHistoryInfo, delReserveRoomHistoryInfo, addReserveRoomHistoryInfo, updateReserveRoomHistoryInfo } from "@/api/manage/reserveRoomHistoryInfo";

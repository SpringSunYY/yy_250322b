...
public class UserBalanceInfoController extends BaseController
{
    ...
    {
        UserBalanceInfo userBalanceInfo = userBalanceInfoService.selectUserBalanceInfoById(id);
    ...
    {
        return toAjax(userBalanceInfoService.deleteUserBalanceInfoByIds(ids));
    }
}

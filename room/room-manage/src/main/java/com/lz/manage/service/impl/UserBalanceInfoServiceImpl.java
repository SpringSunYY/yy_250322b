...
public class UserBalanceInfoServiceImpl extends ServiceImpl<UserBalanceInfoMapper, UserBalanceInfo> implements IUserBalanceInfoService {
    ...
    public UserBalanceInfo selectUserBalanceInfoById(Long id) {
        return userBalanceInfoMapper.selectUserBalanceInfoById(id);
    }
    ...
    public int deleteUserBalanceInfoByIds(Long[] ids) {
        return userBalanceInfoMapper.deleteUserBalanceInfoByIds(ids);
    }
    ...
    public int deleteUserBalanceInfoById(Long id) {
        return userBalanceInfoMapper.deleteUserBalanceInfoById(id);
    }
    ...
    public QueryWrapper<UserBalanceInfo> getQueryWrapper(UserBalanceInfoQuery userBalanceInfoQuery) {
        ...
        Long id = userBalanceInfoQuery.getId();
        queryWrapper.eq(StringUtils.isNotNull(id), "id", id);

        Long userId = userBalanceInfoQuery.getUserId();
        queryWrapper.eq(StringUtils.isNotNull(userId), "user_id", userId);

        BigDecimal balance = userBalanceInfoQuery.getBalance();
        queryWrapper.eq(StringUtils.isNotNull(balance), "balance", balance);
